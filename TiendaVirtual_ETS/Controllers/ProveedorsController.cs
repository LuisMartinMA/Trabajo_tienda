...
namespace TiendaVirtual_ETS.Controllers
{
    public class ProveedorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProveedorID,Nombre,NombreContacto,ApellidoContacto,Telefono,Direccion,Email")] Proveedor proveedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProveedorID,Nombre,NombreContacto,ApellidoContacto,Telefono,Direccion,Email")] Proveedor proveedor)
        {
            if (ModelState.IsValid)
            {

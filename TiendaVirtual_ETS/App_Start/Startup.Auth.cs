    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseFacebookAuthentication(
              appId: "488074085781557",
             appSecret: "3e86aef0ca29b60ae504beadc46ff555");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "808093775559-4ppil309apr93scmb8fbp4tfsgvpsan4.apps.googleusercontent.com",
                ClientSecret = "VQsWzSYP7V6myCnOMzVNbw4h"
            });
        }
    }
}